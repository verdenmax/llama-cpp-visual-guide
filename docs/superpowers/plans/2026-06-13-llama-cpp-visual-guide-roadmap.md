...
| --- | --- | --- | --- | --- | --- |
| **M0** | 脚手架 | 样板 1-2 课 | `shell.py`(双语) · `registry.py` · `build.py` · 样板课 · `index.html` · `check_*.py` 跑通 | `...-M0-scaffold.md` | 计划中 |
| **M1** | 第一部分 · 宏观全景 | 1-3 | 3 课（含整体结构图），确立"图+伪代码+详尽"基线 | `...-M1-part1-overview.md` | 待写 |
| **M2** | 第二部分 · 前置基础 | 4-7 | 4 课 | `...-M2-part2-foundations.md` | 待写 |
| **M3** | 第三部分 · ggml 引擎 | 8-13 | 6 课 | `...-M3-part3-ggml.md` | 待写 |
| **M4** | 第四部分 · llama 推理内部 | 14-24 | 11 课（量大，写 plan 时可拆 M4a/M4b） | `...-M4-part4-llama.md` | 待写 |
| **M5** | 第五部分 · 公共 API 与工具 | 25-30 | 6 课 | `...-M5-part5-tools.md` | 待写 |
| **M6** | 第六部分 · 底层内核 | 31-33 | 3 课（CPU/CUDA 主线 + 其它后端概览） | `...-M6-part6-kernels.md` | 待写 |
