...
<table class="t">
  ...
  <tr><td><span class="mono">split_seq</span></td><td>把同一序列的 token 切到一起</td><td>要求"同序列连续"的模型（如 recurrent，L19 变体）</td></tr>
</table>
...
<table class="t">
  ...
  <tr><td><span class="mono">split_seq</span></td><td>group one sequence's tokens together</td><td>models requiring "same-sequence contiguity" (e.g. recurrent, an L19 variant)</td></tr>
</table>
